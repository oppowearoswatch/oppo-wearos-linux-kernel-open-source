...
#yangyulin@oppo.wear.platform, 2020/02/15, modify for orca/beluga compatible
#DLKM_DIR := $(TOP)/device/oppo/orca/common/dlkm
DLKM_DIR := $(TOP)/device/oppo/common/common/dlkm
else
